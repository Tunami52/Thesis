...
\begin{proof}
    Let $W_1$ and $W_2$ be as in the statement of the theorem and let $W_i(u)$ be the initial segment $\left\{v \in W_i \,\vert\, v < u\right\}$ of $W_i$ for $i \in \left\{1,\, 2\right\}$.
