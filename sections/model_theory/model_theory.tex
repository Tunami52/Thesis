...
\begin{example}
    ...
    If we substitute the formulas $\phi_1(v_1,\, v_2) = v_1 + 1 < v_2$ and $\phi_2(v_1,\, v_2) = v_2 \cdot v_1 = v_1$ into $\tau$,
    we have that
    \begin{align*}
        \tau_r(v_1,\, v_2) 
        &= \left(\phi_1(v_1,\, v_2) \implies \phi_2(v_1,\, v_2)\right) \vee \left(\phi_2(v_1,\, v_2) \implies \phi_1(v_1,\, v_2)\right) \\
...
However, this type of formality is needed for the next definition.
...
\section{Structes and Theories}
\begin{definition}
    A $\mathcal{L}$-\textit{structure} or $\mathcal{M}$ is given by the following:
    \begin{enumerate}
    ...
    We sometimes also identify a structure $\mathcal{M}$ with the pair $\left<M,\, \mathcal{I}\right>$, 
