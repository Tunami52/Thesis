...
We can think of a formula in sentential logic as a placeholders $S_1,\ldots,\, S_n$ chained together with logical connectives.
...
\begin{theorem}[Lindenbaum's Theorem]\label{lindenbaums-theorem}\cite[Lemma 1.2.9]{Cha90}, see also \cite[Proposition 1.3.11]{Cha90}.
...
\begin{example}\cite[Example 1.2.5]{Mar02}
    ...
    \end{equation}
    We then have that $$\mathbf{Z} / 2 \mathbf{Z} \models T \wedge \exists x\, \exists y\, \exists z \ \left(x \neq y \wedge y \neq z \wedge x \neq z\right).$$
